    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex-shrink-0 flex items-center">
          <div class="flex items-center space-x-3">
            ...
            <div class="hidden sm:block">
              ...
              <p class="text-xs text-muted-foreground">Gestão de pedidos</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <!-- Botão de logout -->
          <button @click="handleLogout" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
